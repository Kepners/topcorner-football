...
export const metadata = buildMetadata({
  title: "Football Shooting Blog",
  description:
    "SEO-focused football training articles covering shooting drills, top-corner finishing, solo practice, and striker development.",
  path: "/blog",
  keywords: [
